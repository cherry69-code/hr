...
declare module '@fastify/jwt' {
  interface FastifyJWT {
    payload: { sub: string; email?: string; role?: string; tenant_id?: string; type?: string; jti?: string; fid?: string };
    user: { sub: string; email?: string; role?: string; tenant_id?: string; type?: string; jti?: string; fid?: string };
  }
}
