...
export class SidebarComponent {
  ...
  menuItems = [
    ...
    { label: 'Dashboard', icon: 'layout-dashboard', link: '/dashboard', roles: ['admin', 'hr', 'employee', 'manager'] },
    { label: 'Employees', icon: 'users', link: '/employees', roles: ['admin', 'hr', 'manager'] },
    { label: 'Attendance', icon: 'clock', link: '/attendance', roles: ['admin', 'hr', 'employee', 'manager'] },
    { label: 'Attendance Adjustment', icon: 'edit', link: '/attendance/adjustment', roles: ['admin', 'hr'] },
    { label: 'Leaves', icon: 'calendar', link: '/leaves', roles: ['admin', 'hr', 'employee', 'manager'] },
    { label: 'Payroll', icon: 'banknote', link: '/payroll', roles: ['admin', 'hr', 'employee', 'manager'] },
    { label: 'Biometric', icon: 'fingerprint', link: '/biometric', roles: ['admin', 'hr'] },
    { label: 'Locations', icon: 'map-pin', link: '/locations', roles: ['admin', 'hr'] },
    { label: 'Incentives', icon: 'trending-up', link: '/incentives', roles: ['admin', 'hr', 'employee', 'manager'] },
    ...
    { label: 'Documents', icon: 'file-text', link: '/documents', roles: ['admin', 'hr', 'employee', 'manager'] },
